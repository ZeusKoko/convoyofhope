        ...
        <div class="content-header">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Nababur Rahaman</li>
              </ol>
            </nav>
            <div class="create-item">
                <a href="editprofile.html" class="theme-primary-btn btn btn-primary"><i class="material-icons">add</i>Edit profile</a>
                <a href="" class="btn btn-secondary"><i class="material-icons md-18">arrow_back</i>Back To Userlist</a>
            </div>
        </div>
          <!--  Header BreadCrumb -->   
          <!-- Create New User -->   
                    ...
                    <div class="viewuser row">
                        ...
                        <div class="col-md-6">
                            <div class="user-thumb">
                                <img id="profile-photo" src="https://dw3i9sxi97owk.cloudfront.net/uploads/thumbs/db9c4e1327eb8fe5e9395a4b04e1ea4a_70x70.jpg"  alt="">
                            </div>
